		...
		<header className="fixed top-0 left-0 z-50 w-full bg-white">
			<div className="flex items-center px-4 py-3 border-b shadow-sm md:gap-8 md:py-4 lg:px-6 xl:px-10 lg:gap-9 ">
				...
				<div className="flex items-center gap-3 ml-auto">
					<Link
						href="#"
						className="flex items-center gap-3 px-4 py-2 text-sm font-medium transition ease-in-out rounded-full min-w-max bg-primary-500/20 text-primary-500 hover:bg-primary-500/30 active:scale-95"
					>
